...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2017 at 03:55 AM
...
--
CREATE DATABASE IF NOT EXISTS `dev_laravel_v53` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `dev_laravel_v53`;
...
INSERT INTO `slideshows` (`slideshow_id`, `slideshow_name`, `slideshow_img`) VALUES
(1, 'slideshow1', 'abcde'),
(2, 'slideshow2', 'abcdef');
