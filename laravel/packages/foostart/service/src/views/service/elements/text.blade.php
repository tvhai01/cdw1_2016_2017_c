...
<div class="form-group">
    ...
    {!! Form::text($description_1, $service_description_1, ['class' => 'form-control', 'placeholder' => trans('service::service_admin.description_1').'']) !!}
    <!--Img_2-->
    ...
    {!! Form::text($description_2, $service_description_2, ['class' => 'form-control', 'placeholder' => trans('service::service_admin.description_2').'']) !!}
</div>
<!-- /SAMPLE NAME -->